# frontend-design skill — verbatim capture

**Captured:** 2026-08-10 via `mcp__claude-design__read_design_skill { skill: "frontend-design" }`.
Live source is that tool. Fetch it when **no** design system or brand governs the work.

---

# Frontend design — aesthetic direction outside a brand system
